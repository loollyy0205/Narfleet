        ...
        <div>
            <div className="explore-next">
                <div className="explore-box">
                    ...
                    <div>
                        <span className="Optima-B navi-title"><span style={{color: '#5A7634'}}>EXPLORE NEXT <MdNavigateNext className="next-icon"/></span>CONTACT</span>
                        <br/>
...
export default AnnouncementsExplore