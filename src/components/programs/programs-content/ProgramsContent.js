        ...
        <div>
            <div className='programs-container'>
                ...
                {content.map( (progCont, i) => (
                    <div key={`some-content${i}`} className="programs-content">
                        <div className="left-image">
                            <img src={progCont.photo} alt='hopo wps' />
                        </div>

                        <div className="programs-context">
                            <div className="green-color">
                                <p className="green-color"><span className="programs-title">{progCont.title} </span> <span className="title-sub">{progCont.subTitle}</span></p>
                            </div>

                            <p className="title-content-programs">{progCont.context}</p>
