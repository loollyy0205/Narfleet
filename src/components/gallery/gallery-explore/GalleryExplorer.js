        ...
        <div>
            <div className="explore-next2">
                <div className="explore-box2">
                    ...
                    <div>
                        <span className="Optima-B navi-title2"><span style={{color: '#5A7634'}}>EXPLORE NEXT <MdNavigateNext className="next-icon2"/></span>ANNOUNCMENTS</span>
                        <br/>
